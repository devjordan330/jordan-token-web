    ...
    <div className="min-h-screen text-white font-sans bg-[#050505] overflow-x-hidden relative">
      ...
      <div className="relative z-10">
        <nav className="flex justify-between items-center p-6 max-w-7xl mx-auto border-b border-white/5">
          ...
          <button onClick={() => open()} className="bg-[#ff5c00] hover:bg-[#e65200] text-white px-8 py-3 rounded-full text-xs font-black transition-all shadow-lg uppercase">
        ...
        <main className="max-w-7xl mx-auto px-6 pt-20 text-center">
          ...
          <button onClick={() => open()} className="bg-white text-black px-14 py-5 rounded-2xl font-black uppercase text-sm hover:scale-105 transition shadow-2xl tracking-widest">
            Join the Pack
          </button>
